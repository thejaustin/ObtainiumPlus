...
class LegacySettingsPage extends StatefulWidget {
  const LegacySettingsPage({super.key});

  @override
  State<LegacySettingsPage> createState() => _LegacySettingsPageState();
}

class _LegacySettingsPageState extends State<LegacySettingsPage> {
            ...
            child: Padding(
              ...
              child: settingsProvider.prefs == null
                  ...
                  : Column(
                      ...
                      children: [
                        // PLUS FEATURES SECTION (Added for toggle accessibility)
                        PlusFeaturesSection(),
                        height32,
                        Text(
                          tr('updates'),
