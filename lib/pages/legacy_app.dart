...
import 'package:flutter_markdown/flutter_markdown.dart'; // Changed from flutter_markdown_plus
import 'package:obtainium/components/category_editor_selector.dart'; // Added
import 'package:obtainium/components/generated_form_modal.dart';
import 'package:obtainium/custom_errors.dart';
import 'package:obtainium/main.dart';
import 'package:obtainium/models/app_in_memory.dart'; // Added
...
class LegacyAppPage extends StatefulWidget {
  const LegacyAppPage({
    super.key,
    required this.appId,
  ...
  @override
  State<LegacyAppPage> createState() => _LegacyAppPageState();
}

class _LegacyAppPageState extends State<LegacyAppPage> {
